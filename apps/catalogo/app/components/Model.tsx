            ...
            <div className="md:col-span-7 space-y-4">
              <div className="bg-[var(--color-paper)] rounded-xl p-5 border border-[var(--color-line)]">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--color-sky-soft)] flex items-center justify-center flex-shrink-0 font-mono text-sm text-[var(--color-sky-ink)] font-bold">1</div>
                  <div>
                    ...
                    <p className="text-sm text-[var(--color-ink-soft)] leading-relaxed">
                      ...
                      chatbot si spegne. Come qualsiasi abbonamento non
                      rinnovato.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-[var(--color-paper)] rounded-xl p-5 border border-[var(--color-line)]">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--color-sky-soft)] flex items-center justify-center flex-shrink-0 font-mono text-sm text-[var(--color-sky-ink)] font-bold">2</div>
                  <div>
                    <div className="font-display text-xl text-[var(--color-ink)] mb-1 leading-tight">
              ...
              <div className="bg-[var(--color-paper)] rounded-xl p-5 border border-[var(--color-line)]">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--color-sky-soft)] flex items-center justify-center flex-shrink-0 font-mono text-sm text-[var(--color-sky-ink)] font-bold">4</div>
                  <div>
                    <div className="font-display text-xl text-[var(--color-ink)] mb-1 leading-tight">
